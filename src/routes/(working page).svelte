<script lang="ts">
  import { setInventoryContext } from "$lib/state/inventory.svelte";
...
<Resizable.PaneGroup direction="horizontal">
  <!-- Products Pane -->
  <Resizable.Pane defaultSize={10} class="min-w-[100px]">
  ...
  <Resizable.Pane class="min-w-[300px]">
    <Card.Root class="m-2 mx-1">
      <Card.Header>
        <Card.Title class="flex items-center">
          <img src="{base}/images/cube.png" class="w-8" alt="product icon" />
          <Input placeholder="Product Name" class="border-none text-xl md:text-xl" />
